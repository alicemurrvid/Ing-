...
public class WirelessConnection extends Thread {
	...
	private static String CLOSINGMOVEMENT = BotAction.ClosingMovement.toString(); 
	private static String OPENINGMOVEMENT = BotAction.OpeningMovement.toString(); 
